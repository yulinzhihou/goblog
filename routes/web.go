...
func RegisterWebRoutes(r *mux.Router) {
	...
	r.HandleFunc("/auth/resetpassword", auc.ResetPassword).Methods("POST").Name("auth.resetpassword")
	r.HandleFunc("/auth/send_email", auc.SendEmail).Methods("GET").Name("auth.send_email")
